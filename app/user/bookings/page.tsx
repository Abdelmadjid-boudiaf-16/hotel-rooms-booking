...
const BookingsPage = async () => {
  ...
  return (
    <div>
      {bookings.length > 0 ? <UserBookingsList bookings={bookings} /> : <div className="mt-10 flex flex-col gap-8 items-center justify-center">
        <p className="text-lg">Empty. See our available rooms</p>
        <div>
          <Button asChild><Link href={'/'} className="capitalize">check availabel rooms</Link></Button>
        </div>
